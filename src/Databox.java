...
public class Databox {
    ...
    public double det_rate, threshold_K;
    public double thickness, thickness_stDev;
    public double[] event_counters;



    public Databox(double det_rate, double threshold_K, double thickness, double[] event_counters){
    ...
    public double[] allDataInAnArray(){
        double[] non_counters = new double[]{threshold_K, det_rate, thickness, thickness_stDev};
    ...
    public static Databox add(Databox d1, Databox d2){
        ...
        return new Databox(d1.det_rate+d2.det_rate, d1.threshold_K+d2.threshold_K, d1.thickness+d2.thickness, added_counters);
    }
    ...
    public static Databox divideBy(Databox db, double divisor){
        ...
        return new Databox(db.det_rate/divisor, db.threshold_K/divisor, db.thickness/divisor, scaled_counters);
    }
